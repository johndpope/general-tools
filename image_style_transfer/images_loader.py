...
class ImagesLoader():
    ...
    def image(self, dir, n):
        return _get_image_np(dir, n, self.output_shape)
    def style(self, n):
        return _get_image_np(self.styles_dir, n, self.output_shape)
    def content(self, n):
        return _get_image_np(self.content_dir, n, self.output_shape)
    def output(self, n):
        return _get_image_np(self.outputs_dir, n, self.output_shape)
